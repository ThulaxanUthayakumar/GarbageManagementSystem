        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WasteCategoryId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionSchedules_WasteCategories_WasteCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CollectionRequests_Residents_ResidentId",
                        column: x => x.ResidentId,
                        principalTable: "Residents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionRequests_WasteCategories_WasteCategoryId",
                        column: x => x.WasteCategoryId,
                        principalTable: "WasteCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionRequests_ResidentId",
                table: "CollectionRequests",
                column: "ResidentId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionRequests_Status",
                table: "CollectionRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionRequests_WasteCategoryId",
                table: "CollectionRequests",
                column: "WasteCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionSchedules_WasteCategoryId",
                table: "CollectionSchedules",
                column: "WasteCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionSchedules_Zone",
                table: "CollectionSchedules",
                column: "Zone");
